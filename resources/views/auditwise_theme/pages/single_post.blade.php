...
@section('content')
<div id="single_post_container" class="about_container">
    ...
    <div class="single_post_social">
        <div class="social_button fb_button"><i class="fa fa-facebook" aria-hidden="true"></i>
        facebook</div>
        <div class="social_button twitter_button"><i class="fa fa-twitter" aria-hidden="true"></i>
        twitter</div>
        <div class="social_button g_button"><i class="fa fa-google-plus" aria-hidden="true"></i>
        google +</div>
    </div>
    <div class="about_text single_post_text">
...
<div id="go_to_news">
    <a href="">back to our news page</a>
</div>
